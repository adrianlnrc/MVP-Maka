  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Entrar no Maka</h1>
        <p className="text-gray-500 mb-8">Continue sua jornada bíblica</p>
        ...
        <div className="mt-6 text-center space-y-3">
          <Link href="/recuperar-senha" className="text-sm text-brand-600 hover:underline">
            Esqueci minha senha
          </Link>
